        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white p-6 rounded-lg shadow-md">
                ...
                <center>
                    ...
                    <center>
                        <img src="IMG_5551.JPEG" alt="" class="cursor-pointer" onclick="openModal123(this.src)" width="350px">
                    </center>
                                    ...
                                    <?php while ($row = $result_fees->fetch_assoc()): ?>
                                        ...
                                        <tr class="<?php echo $row_class; ?>">
                                            <?php if ($row['slip'] === null): ?>
                                                <form action="" method="post" enctype="multipart/form-data">
                                                    <td class="border px-4 py-2 text-center">
                                                        ...
                                                        <center><input type="file" id="imageInput" name="image" accept="image/*" onchange="previewImage(event)" class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border file:border-gray-300 file:cursor-pointer hover:file:bg-gray-100"></center>
                                            ...
                                            <td class="border px-4 py-2 text-center">
                                                ...
                                                <?php else: ?>
                                                    <center>
                                                        <img src="slip/<?php echo $row['slip']; ?>" alt="" class="cursor-pointer" width="125px" onclick="openModal(this.src)">
                                                    </center>
